...
/*   Updated: 2023/06/10 16:34:06 by oredoine         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
extern t_llist	*swap_first_e(t_llist *head);
extern void 	print_list(t_llist *head); 
extern t_llist	*push_to_stack(t_llist **src, t_llist *dest);
extern void	    ft_lstadd_front(t_llist **lst, t_llist *new); 
extern t_llist  *rotate_stack(t_llist **head);
extern t_llist  *reverse_rotate(t_llist **head);
...
extern int      get_moves_to_top(t_llist *stack, int t);
