...
./src/instructions/rotate.o ./src/instructions/rev_rotate.o ./src/instructions/rr.o ./src/instructions/rrr.o ./src/parsing/check.o ./src/parsing/pars_err.o ./src/sorting/main_sorts.o  \
